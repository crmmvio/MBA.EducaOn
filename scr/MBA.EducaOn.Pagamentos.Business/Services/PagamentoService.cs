...
using MBA.EducaOn.Pagamentos.Business.Enumerators;
using MBA.EducaOn.Pagamentos.Business.Interfaces;
using MBA.EducaOn.Vendas.Domain;

namespace MBA.EducaOn.Pagamentos.Business.Services;
...
public class PagamentoService : IPagamentoService
{
    ...
    public async Task<Transacao> RealizarPagamentoPedido(PagamentoPedido pagamentoPedido)
    {
        ...
        {
            pagamento.AdicionarEvento(new PedidoPagamentoRealizadoEvent(pedido.Id, pagamentoPedido.ClienteId, transacao.PagamentoId, transacao.Id, pedido.ValorTotal));
        ...
        await _mediatorHandler.PublicarEvento(new PedidoPagamentoRecusadoEvent(pedido.Id, pagamentoPedido.ClienteId, transacao.PagamentoId, transacao.Id, pedido.ValorTotal));
